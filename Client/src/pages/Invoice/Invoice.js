        ...
        <>
            <div className='invoice'>
                <div className='invoice_form'>
                    ...
                    <div className='invoice_code'>
                        <h1> Ngày thu tiền: </h1>
                        {/* <span>ngày: {new Date(abate.room[0].date[0]).getDate() + '/' + new Date(abate.room[0].date[0]).getMonth() + '/' + new Date(abate.room[0].date[0]).getFullYear()}</span> */}
                    </div>
